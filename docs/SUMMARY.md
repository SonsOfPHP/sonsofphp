...
* [CQRS](components/cqrs.md)
* [Event Dispatcher](components/event-dispatcher.md)
* [Event Sourcing](components/event-sourcing/README.md)
  * [Aggregates](components/event-sourcing/aggregates/README.md)
    * [Aggregate Repository](components/event-sourcing/aggregates/aggregate-repository.md)
...
* [Http Factory](components/http-factory.md)
* [Http Handler](components/http-handler.md)
